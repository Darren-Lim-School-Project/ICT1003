...
void newMenu(int8_t newIndex) {
  ...
  if (menuHistoryIndex) {
    ...
    outOfTempSelection = 1;

    if (outOfFlappyBirdSelection == 0) {
      rewriteDateBTBatt = true;
    }
    outOfFlappyBirdSelection = 1;
...
static const char PROGMEM mainMenuStrings3[] = "Temperature";
static const char PROGMEM mainMenuStrings4[] = "FlappyBird";
...
void viewMenu(uint8_t button) {
  ...
  if (!button) {
    ...
    if (button == upButton) {
      ...
      if (menu_debug_print) {
        SerialMonitorInterface.print("currentMenuLine ");
        SerialMonitorInterface.println(currentMenuLine);
        SerialMonitorInterface.print("currentSelectionLine ");
        SerialMonitorInterface.println(currentSelectionLine);
        SerialMonitorInterface.print("select ");
        SerialMonitorInterface.println(currentMenuLine + currentSelectionLine);
      }
